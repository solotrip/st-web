...
import {
  addToClusters,
  removeFromClusters
} from '../../../preferences/containers/area-cluster/slice'
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.slideHolder}>
        {areas.map(area => (
          <button
            className={
              clusters.includes(area.cluster)
                ? styles.selected
                : styles.notSelected
            }
            onClick={() => {
              handleCluster(area.cluster)
            }}
          >
            <ImageShadow
              src={area.link}
              ...
              alt="a"
            />
            <div className={styles.slideText2}>{area.title}</div>
          </button>
        ))}
      </div>
    </div>
