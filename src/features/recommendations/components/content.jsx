...
const Content = ({
  ...
  >
    <button
      ...
      onClick={tabSelect}
    >
      <MdOutlineStar className={styles.tabIcon} />
    ...
    <button
      ...
      onClick={tabSelect}
    >
      <MdBarChart className={styles.tabIcon} />
    ...
    <button
      ...
      onClick={tabSelect}
    >
      <MdMap className={styles.tabIcon} />
  ...
  const list = !loading && (
    ...
    >
      ...
      {(!loading && recommendations.length > 0 && activeTab === 'Recommendations') &&
